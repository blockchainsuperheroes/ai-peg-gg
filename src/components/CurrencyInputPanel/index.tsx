import { Currency, Pair } from '../../dist'
          ...
          {!hideInput && (
            <>
              ...
              {account && currency && showMaxButton && label !== 'To' && (
                <>
                  <PercentageButtons>
                    <PercentButton onClick={() => onPercent && onPercent(25)}>25%</PercentButton>
                    <PercentButton onClick={() => onPercent && onPercent(50)}>50%</PercentButton>
                  </PercentageButtons>
